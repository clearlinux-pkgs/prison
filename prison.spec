...
Version  : 5.115.0
Release  : 75
URL      : https://download.kde.org/stable/frameworks/5.115/prison-5.115.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.115/prison-5.115.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.115/prison-5.115.0.tar.xz.sig
...
%prep
%setup -q -n prison-5.115.0
cd %{_builddir}/prison-5.115.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707697436
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5Prison.so.5.115.0
/V3/usr/lib64/libKF5PrisonScanner.so.5.115.0
...
/usr/lib64/libKF5Prison.so.5.115.0
/usr/lib64/libKF5PrisonScanner.so.5
/usr/lib64/libKF5PrisonScanner.so.5.115.0
