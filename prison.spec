...
Version  : 6.13.0
Release  : 95
URL      : https://download.kde.org/stable/frameworks/6.13/prison-6.13.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.13/prison-6.13.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.13/prison-6.13.0.tar.xz.sig
...
%setup -q -n prison-6.13.0
cd %{_builddir}/prison-6.13.0
pushd ..
cp -a prison-6.13.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744649777
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6Prison.so.6.13.0
/V3/usr/lib64/libKF6PrisonScanner.so.6.13.0
...
/usr/lib64/libKF6Prison.so.6.13.0
/usr/lib64/libKF6PrisonScanner.so.6
/usr/lib64/libKF6PrisonScanner.so.6.13.0
