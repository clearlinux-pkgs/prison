...
Version  : 5.98.0
Release  : 54
URL      : https://download.kde.org/stable/frameworks/5.98/prison-5.98.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.98/prison-5.98.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.98/prison-5.98.0.tar.xz.sig
...
%prep
%setup -q -n prison-5.98.0
cd %{_builddir}/prison-5.98.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662942230
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Prison.so.5.98.0
/usr/lib64/libKF5PrisonScanner.so.5
/usr/lib64/libKF5PrisonScanner.so.5.98.0
