...
Source0  : https://download.kde.org/stable/frameworks/5.68/prison-5.68.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.68/prison-5.68.0.tar.xz.sig
...
%prep
%setup -q -n prison-5.68.0
cd %{_builddir}/prison-5.68.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584304926
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/prison-5.68.0/LICENSE %{buildroot}/usr/share/package-licenses/prison/31eac83f9b89a1cf6b14d0a55ea581070601be5d
cp %{_builddir}/prison-5.68.0/cmake/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/prison/ff3ed70db4739b3c6747c7f624fe2bad70802987
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5Prison.so.5.68.0
